...
export class DatabaseManager {
  ...
  private static WASM_CDN_URL =
    'https://mirrors.cloud.tencent.com/npm/@electric-sql/pglite/0.2.13/files/dist/postgres.wasm';

  private static FSBUNDLER_CDN_URL =
    'https://mirrors.cloud.tencent.com/npm/@electric-sql/pglite/0.2.13/files/dist/postgres.data';

  private static VECTOR_CDN_URL =
    'https://mirrors.cloud.tencent.com/npm/@electric-sql/pglite/0.2.13/files/dist/vector.tar.gz';
